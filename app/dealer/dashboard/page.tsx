...
export default function DealerDashboard() {
  ...
  const translations = {
    ...
    es: {
      ...
      Marketing: "Marketing",
      "Access marketing materials and content": "Acceda a materiales y contenido de marketing",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            >
              <div className="flex flex-col items-center text-center">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/fabrica-8rAL1ekG7N6lEONmBlpf1PnxEuKgX3.png"
          ...
          {/* Second Row - 3 Cards (now including Marketing) */}
